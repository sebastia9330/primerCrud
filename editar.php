    ...
    <body>
        ...
        <form class='col-4 p-4 m-auto' method='POST'>
            ...
            <div class='mb-3'>
                ...
                <input  class="form-control" type='text' id='nombre' name='nombre' value="<?php echo htmlspecialchars($producto['nombre']); ?>">
            </div>
            <div class='mb-3'>
                <label class="form-label" for='precio'>Precio</label>
                <input class="form-control" type='text' id='precio' name='precio' value="<?php echo htmlspecialchars($producto['precio']); ?>">
            </div>
            <div class='mb-3'>
                <label class="form-label" for='descripcion'>Descripcion</label>
                <input class="form-control" type='text' id='descripcion' name='descripcion' value="<?php echo htmlspecialchars($producto['descripcion']); ?>">
            </div>
            <div class='mb-3'>
                <label class="form-label" for='stock'>Stock</label>
                <input class="form-control" type='text' id='stock' name='stock' value="<?php echo htmlspecialchars($producto['stock']); ?>">
            </div>
            <div class='mb-3'>
                <label class="form-label" for='fecha_ingreso'>Fecha Ingreso</label>
                <input class="form-control" type='date' id='fecha_ingreso' name='fecha_ingreso' value="<?php echo htmlspecialchars($producto['fecha_ingreso']); ?>">
            </div>
